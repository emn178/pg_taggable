...
ActiveRecord::Schema[8.0].define(version: 2025_04_05_014623) do
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.bigint "user_id"
    t.string "title"
    t.string "strings", default: [], array: true
    t.text "texts", default: [], array: true
    t.integer "integers", default: [], array: true
    t.citext "citexts", default: [], array: true
